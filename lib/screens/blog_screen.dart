...
class _BlogScreenState extends State<BlogScreen>
  ...
  @override
  void initState() {  ///function used for Tab bars
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Container( 
      child: Column( /// couloum have(the header image , avatar,title, description and tab bars )
          ...
          children: <Widget>[
            Stack(alignment: Alignment.center, children: <Widget>[
              ...
              Avatar(), /// show avatar in circle
              AvatarImage()
            ]),
            Container(   /// start of Tab Bars
                color: Constant.bottomCoverColor,  
                child: TabBar(
                  unselectedLabelColor: Color(0xffc7c1c1), 
                  labelColor: Constant.accent, ///color of label of selected item we can change it from edit
                  indicatorColor: Constant.accent,      ///color of indicator of selected item releted to label
                  tabs: [
                    Tab(text: 'Posts'),
                    Tab(
                      text: 'Likes',
